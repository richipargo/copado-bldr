    ...
    switch (req) {
      case "search":
        ...
        if (typeof argv.f === "string" && argv.f.includes(":")) {
          ...
          allowTracking() &&
            incrementMetric("req_searches_sharedDataExtension_folders");
        } else if (
          ...
          allowTracking() &&
            incrementMetric("req_searches_dataExtension_folders");
        }
        ...
        if (typeof argv.a === "string" && argv.a.includes(":")) {
          ...
          allowTracking() &&
            incrementMetric("req_searches_sharedDataExtension_assets");
          ...
          allowTracking() &&
            incrementMetric("req_searches_dataExtension_assets");
        }
      ...
      case "clone":
        ...
        if (typeof argv.f === "string" && argv.f.includes(":")) {
          ...
          allowTracking() &&
            incrementMetric("req_clones_sharedDataExtension_folders");
        } else if (
          (typeof argv.f === "string" && !argv.f.includes(":")) ||
          typeof argv.f === "number"
        ) {
          ...
          allowTracking() &&
            incrementMetric("req_clones_dataExtension_folders");
        }
        ...
        if (typeof argv.a === "string" && argv.a.includes(":")) {
          ...
          } = await emailStudio.gatherAssetById(
            customerKey,
            completeResponse,
            shared
          );
