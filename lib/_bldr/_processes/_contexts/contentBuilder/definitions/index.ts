...
const setContentBuilderDefinition = async (
  ...
  switch (sfmcUpdateObject.assetType.name) {
    case "webpage":
      assetOutput =
        updatedContent &&
        (await setCloudPage(sfmcUpdateObject, updatedContent));
      break;
    case "htmlemail":
      assetOutput =
        updatedContent &&
        (await setHTMLEmail(sfmcUpdateObject, updatedContent));
      break;
    case "htmlblock":
    ...
    case "xmlcoderesource":
      assetOutput =
        updatedContent &&
        (await SetContentBlock(sfmcUpdateObject, updatedContent));
      break;
    default:
