...
const normalizedENVPath = path_1.default.join(normalizedRoot, "/copado/copado.json");
exports.normalizedENVPath = normalizedENVPath;
const normalizedTemplateENVPath = path_1.default.join(normalizedRoot, "/copado/copado.json");
...
const normalizedManifestJSONPath = path_1.default.join(normalizedRoot, ".copado.manifest.json");
