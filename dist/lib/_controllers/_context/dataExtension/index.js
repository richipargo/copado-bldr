        ...
        switch (req) {
            case "search":
                ...
                if (typeof argv.f === "string" && argv.f.includes(":")) {
                    ...
                    allowTracking() &&
                        (0, metrics_1.incrementMetric)("req_searches_sharedDataExtension_folders");
                }
                    ...
                    allowTracking() &&
                        (0, metrics_1.incrementMetric)("req_searches_dataExtension_folders");
                }
                /**
                ...
                if (typeof argv.a === "string" && argv.a.includes(":")) {
                    ...
                    allowTracking() &&
                        (0, metrics_1.incrementMetric)("req_searches_sharedDataExtension_assets");
                }
                    ...
                    allowTracking() &&
                        (0, metrics_1.incrementMetric)("req_searches_dataExtension_assets");
                }
                break;
            case "clone":
                ...
                if (typeof argv.f === "string" && argv.f.includes(":")) {
                    ...
                    allowTracking() &&
                        (0, metrics_1.incrementMetric)("req_clones_sharedDataExtension_folders");
                }
                else if ((typeof argv.f === "string" && !argv.f.includes(":")) ||
                    typeof argv.f === "number") {
                    const cloneRequest = yield emailStudio.gatherAssetsByCategoryId({
                    ...
                    allowTracking() &&
                        (0, metrics_1.incrementMetric)("req_clones_dataExtension_folders");
                }
                /**
                 * Search for Data Extension Assets
                 */
