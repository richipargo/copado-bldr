        ...
        switch (req) {
            case "search":
                    ...
                    if (typeof argv.f === "string" && argv.f.includes(":")) {
                        ...
                        switch (searchFlag) {
                            case "shared":
                                ...
                                allowTracking() &&
                                    (0, metrics_1.incrementMetric)("req_searches_sharedContent_folders");
                                break;
                        }
                    }
                        ...
                        allowTracking() &&
                            (0, metrics_1.incrementMetric)("req_searches_contentBuilder_folders");
                    }
                }
                /**
                ...
                if (argv.a) {
                    ...
                    allowTracking() &&
                        (0, metrics_1.incrementMetric)("req_searches_contentBuilder_assets");
                }
                break;
            case "clone":
                ...
                if (argv.f) {
                    if (typeof argv.f === "string" && argv.f.includes(":")) {
                        ...
                        allowTracking() &&
                            (0, metrics_1.incrementMetric)("req_clones_sharedContent_folders");
                    }
                    else if ((typeof argv.f === "string" && !argv.f.includes(":")) ||
                        ...
                        allowTracking() &&
                            (0, metrics_1.incrementMetric)("req_clones_contentBuilder_folders");
                    }
                }
                /**
                 * Search for Content Builder Assets
                ...
                if (argv.a) {
                    ...
                    if (typeof argv.a === "string" && argv.a.includes(":")) {
                        ...
                        assets &&
                            assets.length &&
                            (yield (0, CreateLocalFiles_1.createContentBuilderEditableFiles)(assets));
                        assets &&
                            folders &&
                            (yield (0, manifestJSON_1.updateManifest)("sharedContent", {
                                assets: assets,
                        ...
                        allowTracking() &&
                            (0, metrics_1.incrementMetric)("req_clones_sharedContent_assets");
                    }
                        ...
                        allowTracking() &&
                            (0, metrics_1.incrementMetric)("req_clones_contentBuilder_assets");
                    }
                }
                break;
            case "delete":
                if (argv.f) {
                    ...
                    for (let f = folderIds.length - 1; f >= 0; f--) {
                        const deleteFolderRequest = folderIds &&
                            folderIds.length &&
                            (yield bldr.sfmc.client.soap.delete("DataFolder", {
                                ID: folderIds[f],
                            }));
                    }
                ...
                if (argv.a) {
                    if (argv["force"]) {
                        ...
                        if (deleteRequest === "OK") {
                            ...
                            allowTracking() &&
                                (0, metrics_1.incrementMetric)("req_deletes_contentBuilder_assets");
                        }
                    }
                    else {
