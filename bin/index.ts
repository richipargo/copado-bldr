  ...
  if (!req) {
    ...
    if (argv.h) {
      ...
      displayObject({
        ...
        "-s --set                           ":
          "Set Target Configuration to Use",
        ...
        "--clear-session                    ":
          "Resets Current Session and Forces Token Refresh",
      });
      ...
      displayObject({
        "--cb                               ":
          "Initiate Content Builder Project",
        "--de                               ": "Initiate Data Extension",
        "--env-only                         ":
          "Setup Environment Variables for Project",
        "--update-env-keys                  ":
          "Update /copado/copado.json keys found in content",
      });
      ...
      displayObject({
        "--cb -f <folder id>                ":
          "Content Builder Folder ID to Clone",
        "--cb -a <asset id>                 ":
          "Content Builder Asset ID to Clone",
        "--cb -f:shared <folder id>         ":
          "Shared Content Builder Folder ID to Clone",
        "--cb -a:shared <asset id>          ":
          "Shared Content Builder Asset ID to Clone",
        ...
        "--de -f <folder id>                ":
          "Data Extension Folder Id to Clone",
        "--de -a <customer key>             ":
          "Data Extension Customer Key to Clone",
        "--de -f:shared <folder id>         ":
          "Shared Data Extension Folder Id to Clone",
        "--de -a:shared <customer key>      ":
          "Shared Data Extension Customer Key to Clone",
      });
      ...
      displayObject({
        ...
        "<file path>                        ":
          "Add One or Multiple Assets to the Stash to be Pushed into SFMC",
        "                                   ":
      ...
      displayObject({
        "--sfmc-only                        ":
          "Create files in SFMC only [only recommended for flat packages]",
        "--local-only                       ":
    ...
    if (Object.values(argv).includes(":shared")) {
      ...
      if (
        ...
        displayLine(
          `Shared ${command} must be done from Parent Business Unit`,
          "info"
        );
        displayLine(
